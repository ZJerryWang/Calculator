...
// memory the comthe number being displayed, previous total and operation.
// everytime use setNumberDisplay/setPreviousTotal/setCurrentOperation will give the match value to the function through hook

//Q2: explain what `${numberDisplay}${digit}` does.   
const updateDisplay = digit => {
    setNumberDisplay(`${numberDisplay}${digit}`); //
  };
//it changes the state variable to setNumberDisplay based on what number butten was pressed.
...
// because the numberDisplay is giving the value of itself to setNumberDisplay
